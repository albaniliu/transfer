...
#  for i in range(1000, 1001):
    ...
    for j in range(1, len(results)):
      ...
      if buy > 0:
        ...
        buy = 0.0
        sell = 0.0
      #if isBan(yes_price, highest_price) and lowest_price < highest_price :
      if isBan(yes_price, highest_price) and lowest_price < highest_price and current_price == highest_price:
        print day + " " + stock_id + " yes"
      elif isBan(yes_price, highest_price) and lowest_price < highest_price and current_price < highest_price:
        print day + " " + stock_id + " no"
      #if isBan(yes_price, current_price) and lowest_price < highest_price and open_price == lowest_price:
        #buy = highest_price
#  print str(money)
